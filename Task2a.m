...
disp(cmclass1);
disp('Accuracy for Class 1: ' + string(accuracy1));
...
disp('Confusion Matrix:');
disp(cmclass2);
disp('Accuracy for Class 2: ' + string(accuracy2));
...
disp('Confusion Matrix:');
disp(cmclass3);
disp('Accuracy for Class 3: ' + string(accuracy3));
...
for k = 1:mtst
    input_instance = input("Please enter the instance number (from " + mtst + " records in the test set");
    if(input_instance <= mtst && input_instance > 0)
        ...
        disp(" Probability of Classifier 1: " + hypothesisx1instance * 100 + "%");
        disp(" Probability of Classifier 2: " + hypothesisx2instance * 100 + "%");
        disp(" Probability of Classifier 3: " + hypothesisx3instance * 100 + "%");
        ...
        disp("Instance " +input_instance+ " belongs to the " +class+ " with the highest probability value of " +highest*100+ "%");
